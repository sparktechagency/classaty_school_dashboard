...
interface SchoolAdminAllManagerTableProps {
...
const SchoolAdminAllManagerTable: React.FC<SchoolAdminAllManagerTableProps> = ({
  data,
  loading,
  showEditModal,
  showViewModal,
...
export default SchoolAdminAllManagerTable;
